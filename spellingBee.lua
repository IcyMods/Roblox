...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       ...
       Invite = "discord.gg/kXKWckcr3y", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
    ...
    KeySettings = {
       Title = "Key System",
       Subtitle = "Vortex's Key System",
       Note = "link: ", -- Use this to tell the user how to get a key
...
local Label = MainTab:CreateLabel("Current word: ", 4483362458, Color3.fromRGB(255, 255, 255), false) -- Title, Icon, Color, IgnoreTheme
