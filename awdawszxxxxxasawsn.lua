...
local premiumKey = { key = "XNFBK-8WC79-YZ9BF-RH9NY", expires = 9999999999999999999999 } -- Insanely high expiration
...
local Keybind = Section:Keybind({
    ...
    Callback = function()
        -- Add functionality for what happens when the keybind is pressed
        print("Keybind pressed!")
    end,
    UpdateKeyCallback = function(Key)
        task.wait(0.1)  -- Wait a brief moment to ensure smooth transition
        Window:ChangeTogglekey(Key)  -- Update the keybind display or handling in your window
        print("Keybind updated to: " .. Key.Name)  -- Optionally, print or show updated key
    end
})
...
local function UpdateThisBruhLabel()
    while wait() do
